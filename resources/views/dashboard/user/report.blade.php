...
<div class="page-section">
    <div class="container">
      <h1 class="text-center wow fadeInUp">Report a Problem</h1>
  ...
  @endif
      ...
      <form class="main-form" action="{{route('user.reported')}}" method="POST">
        ...
        <button type="submit" class="btn btn-primary mt-3 wow zoomIn">Send Report</button>
      </form>
    </div>
  </div>
