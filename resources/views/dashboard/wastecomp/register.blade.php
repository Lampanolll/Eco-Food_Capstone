...
<head>
    ...
    <title>Foodwaste Facility Register</title>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-4 offset-md-4" style="margin-top: 45px">
                 <h4>Foodwaste Facility Register</h4><hr>
                 <form action="{{ route('wastecomp.create') }}" method="post">
                    ...
                    <div class="form-group">
                     ...
                     <br>
                     <a href="{{ route('wastecomp.login') }}">I already have an account, Login now</a>
                 </form>
            </div>
        </div>
    </div>
